...
const conversations: Conversation[] = [
  ...
  },
  {
    ...
    status: 'offline',
    kind: 'club',
    lastMessage: 'CLB có buổi open play vào thứ 7 này.',
    lastTime: 'Thứ 2',
    unread: 0,
    location: 'Hà Nội',
    contextTitle: 'Hanoi Elite Pickleball Club',
    contextMeta: '2.450 thành viên',
  },
];
  ...
  'hanoi-elite': [
    {
      ...
      text: 'CLB có buổi open play vào thứ 7 này, bạn muốn mình giữ một suất không?',
      time: 'Thứ 2',
    },
  ],
};
