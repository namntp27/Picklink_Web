    ...
    <AdminShell activeId="posts">
      ...
      <section className="mb-6 flex flex-col justify-between gap-4 md:flex-row md:items-start">
        <div>
          ...
          <h1 className="text-[20px] font-bold leading-tight md:text-[24px]">Quản lý bài viết</h1>
              ...
              {data.items.map((post) => (
                <tr className="align-top hover:bg-surface-container-low" key={post.postId}>
                  ...
                  <td className="max-w-md px-4 py-3">
                    <p className="break-words text-sm leading-6">{post.content || 'Không có nội dung văn bản.'}</p>
