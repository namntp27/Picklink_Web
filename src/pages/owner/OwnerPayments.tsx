...
export const OwnerPayments = () => {
  ...
  return <OwnerShell activeId="payments" innerClassName="max-w-[1320px]">
    <section className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
      <div><p className="inline-flex items-center gap-2 rounded-lg bg-primary/10 px-3 py-2 text-[13px] font-bold text-primary"><ReceiptText className="h-4 w-4" /> Hàng đợi đối soát</p><h1 className="mt-3 text-[30px] font-bold md:text-[40px]">Biên lai chờ xác nhận</h1><p className="mt-2 text-[15px] text-on-surface-variant">Chỉ hiển thị biên lai Player vừa gửi và đang chờ Owner xác nhận hoặc từ chối.</p></div>
